...
/***/ function(module, exports, __webpack_require__) {
	...
	var sampleData = [{ id: 1, author: 'Craig', text: 'Bear Stuff' }, { id: 2, author: 'C7', text: 'Same as everyone else' }];
	...
	var CommentForm = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('textarea', { placeholder: 'Say something', value: this.state.text, onChange: this.handleTextChange }),
