...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ReactDOM.render(React.createElement(PiggyBank, { owner: 'Beth\'s', title: 'piggy bank', colour: 'Red', depositAmount: 2 }), document.getElementById('app'));
	};
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'p',
	        null,
	        React.createElement('input', { type: 'number', onChange: this.changeTotal, id: 'amount', placeholder: 'enter amount' })
	      ),
	      React.createElement(
	        'button',
